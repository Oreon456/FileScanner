...
def process_file():
    ...
    if filepath:
        ...
        result_filepath = filedialog.asksaveasfilename(initialfile=f"processed_{filename}", defaultextension=".png")
        if result_filepath:
...
title_label = tk.Label(window, text="Image Processing Application", font=("Arial", 16, "bold"), fg="darkblue", bg="white")
